...
Dosemap shape matches density shape (z,y,x)	 for Dataset8 (136, 256, 256)
...
directory_path =  '/gpfs001/scratch/schwar14/simudosemapheavyions/DosemapInBrain/build_folders/Miriam2/'

print('conversion files from ',directory_path)
# Save path
save_path = "/home/tappay01/new_data/data8/"
...
for filename in os.listdir(directory_path):
    if filename.endswith('.out') and filename.startswith('Data8'):
        # Start the timer
        ...
        if not os.path.exists(output_filename):
            ...
            try:    
                ...
                print(f"Permission error: {e}. Skipping file: {input_filename}")
                continue
